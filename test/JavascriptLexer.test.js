...
describe('[class] JavascriptLexer', () => {
  test('JavascriptLexer parse result should be correct.', () => {
    ...
    expect(JSON.stringify(highLight.parse('o423423'))).toMatch('[{\"type\":\"identifer\",\"elem\":\"os\"},{\"type\":\"call\",\"elem\":\".\"},{\"type\":\"identifer\",\"elem\":\"cpus\"},{\"type\":\"parenthese\",\"elem\":\"(\"},{\"type\":\"parenthese\",\"elem\":\")\"}]');
  });
});
