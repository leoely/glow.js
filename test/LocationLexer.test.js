...
describe('[class] LocationLexer', () => {
  test('LocationLexer parse result should be correct.', () => {
    ...
    expect(JSON.stringify(highLight.parse('curl http://drip.org.cn:3004/file/install.js -d "" | node -'))).toMatch('[{\"type\":\"namespace\",\"elem\":\"curl\"},{\"type\":\" \"},{\"type\":\"namespace\",\"elem\":\"http\"},{\"type\":\"colon\",\"elem\":\":\"},{\"type\":\"command\",\"elem\":\":/\"},{\"type\":\"slash\",\"elem\":\"/\"},{\"type\":\"namespace\",\"elem\":\"drip\"},{\"type\":\"dot\",\"elem\":\".\"},{\"type\":\"filename\",\"elem\":\"org\"},{\"type\":\"dot\",\"elem\":\".\"},{\"type\":\"suffix\",\"elem\":\"cn\"},{\"type\":\"colon\",\"elem\":\":\"},{\"type\":\"command\",\"elem\":\":3004\"},{\"type\":\"slash\",\"elem\":\"/\"},{\"type\":\"namespace\",\"elem\":\"file\"},{\"type\":\"slash\",\"elem\":\"/\"},{\"type\":\"namespace\",\"elem\":\"install\"},{\"type\":\"dot\",\"elem\":\".\"},{\"type\":\"command\",\"elem\":\"js\"},{\"type\":\" \"},{\"type\":\"option\",\"elem\":\"-d\"},{\"type\":\" \"},{\"type\":\"namespace\",\"elem\":\"\\\"\\\"\"},{\"type\":\" \"},{\"type\":\"or\",\"elem\":\"|\"},{\"type\":\" \"},{\"type\":\"namespace\",\"elem\":\"node\"},{\"type\":\" \"},{\"type\":\"centerLine\",\"elem\":\"-\"}]');
  });
});
