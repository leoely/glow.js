...
describe('[class] LocationLexer', () => {
  test('LocationLexer parse result should be correct.', () => {
    ...
    expect(JSON.stringify(highLight.parse("12.424.321.583"))).toMatch("[{\"type\":\"number\",\"elem\":\"12\"},{\"type\":\"separator\",\"elem\":\".\"},{\"type\":\"number\",\"elem\":\"424\"},{\"type\":\"separator\",\"elem\":\".\"},{\"type\":\"number\",\"elem\":\"321\"},{\"type\":\"separator\",\"elem\":\".\"},{\"type\":\"number\",\"elem\":\"583\"}]");
  });
});
