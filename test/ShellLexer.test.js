...
describe('[class] ShellLexer', () => {
  test('ShellLexer parse result should be correct.', () => {
    ...
    expect(JSON.stringify(highLight.parse('curl https://drip.com/file/install.js | node -'))).toMatch('[{\"type\":\"command\",\"elem\":\"curl\"},{\"type\":\" \"},{\"type\":\" \"},{\"type\":\"|\"},{\"type\":\" \"},{\"type\":\"command\",\"elem\":\"node\"},{\"type\":\" \"},{\"type\":\"-\"}]');
  });
});
