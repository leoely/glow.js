...
describe('[class] VersionLexer;', () => {
  test('VersionLexer parse result should be correct.', () => {
    ...
    expect(JSON.stringify(highLight.parse('git tag v0.0.1'))).toMatch('[{\"type\":\"command\",\"elem\":\"git\"},{\"type\":\" \"},{\"type\":\"subCommand\",\"elem\":\"tag\"},{\"type\":\" \"},{\"type\":\"head\",\"elem\":\"v\"},{\"type\":\"version\",\"elem\":\"0\"},{\"type\":\"dot\",\"elem\":\".\"},{\"type\":\"version\",\"elem\":\"0\"},{\"type\":\"dot\",\"elem\":\".\"},{\"type\":\"version\",\"elem\":\"1\"}]');
  });
});
